#Load data 
test_all <- readRDS("test_set.rds")
train_all <- readRDS("train_set.rds")
...
knn_25 <- knn(train, test, cl = train$code, k =25, l = 0, prob=TRUE)
knn_1 <- knn(train, test, cl = train$code, k =1, l = 0, prob=TRUE)
